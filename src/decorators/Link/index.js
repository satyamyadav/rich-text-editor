...
import { Popover, Text } from '@innovaccer/design-system';
...
function getLinkComponent(config) {
  ...
  return class Link extends Component {
    ...
    render() {
      ...
      const trigger = <Text appearance="link">{children}</Text>;
      ...
      return (
        ...
        >
          <Popover trigger={trigger}>
            <a href={url} target={'_new'} onClick={this.openLink}>{children}</a>
          </Popover>
